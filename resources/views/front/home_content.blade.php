...
@foreach($products as $product)
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{url('uploads').'/'.$product->image}}" width="200px" height="200px" alt="" />
                                            <h2>${{ $product->price }}</h2>
                                            <h2>{{ $product->name }}</h2>
                    ...
                    <button type="submit" class="btn btn-primary btn-outline-dark"><i class="fa fa-cart-plus"></i>Add To Ca</button>
                    </form>
                                        </div>
