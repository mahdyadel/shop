...
<head>
	...
	<link href="{{asset('frontend/css/mahdy.css')}}" rel="stylesheet">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href=""><i class="fa fa-user"></i>{{ auth()->check()? auth()->user()->name :'Acount' }} </a></li>
...
<div class="table-responsive cart_info col-sm-9">
				<table class="table table-condensed">
					...
					@foreach(Cart::instance('default')->content() as $item)
						...
						<tr>
							...
							<img src="{{url('uploads').'/'.$item->model->image}}" width="100px" height="100px" alt="">
							</td>
					...
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<form method="post" id="payment-form" action="{{route('checkout')}}">
								...
								<input type="text" id="postal" name="postal" placeholder="Pstal">
    ...
    <script src="{{url('frontend/js/mahdy.js')}}"></script>
